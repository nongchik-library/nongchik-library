...
<section class="section"><div class="section-title"><span class="num">02</span>รายละเอียดข้อมูล</div><table>${cell('รายละเอียด',description)}${cell('ที่อยู่ / สถานที่',address)}${cell('ผู้รับผิดชอบ',contact)}${cell('ตำแหน่ง',position)}${cell('เบอร์โทรศัพท์',phone)}${cell('ID Line',lineId)}${cell('Facebook',facebook)}${cell('TikTok',tiktok)}${cell(_categoryPrintName() == 'แหล่งเรียนรู้' ? 'ประเภท / กิจกรรมการเรียนรู้' : 'ข้อมูลเพิ่มเติม',extra)}${cell('ประวัติความเป็นมา',backgroundHistory)}${cell('ประวัติของแหล่งเรียนรู้',resourceHistory)}${cell('รางวัลที่ได้รับ',awards)}${widget.type == DataType.subdistrictLearningCenter ? '''
